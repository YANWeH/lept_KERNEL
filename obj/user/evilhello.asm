...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80044b:	ba f4 22 80 00       	mov    $0x8022f4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80046d:	51                   	push   %ecx
  80046e:	50                   	push   %eax
  80046f:	68 78 22 80 00       	push   $0x802278
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006c7:	53                   	push   %ebx
  8006c8:	50                   	push   %eax
  8006c9:	68 b9 22 80 00       	push   $0x8022b9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800838:	53                   	push   %ebx
  800839:	50                   	push   %eax
  80083a:	68 98 22 80 00       	push   $0x802298
...
00800a40 <devfile_read>:
{
  ...
  800a95:	c3                   	ret    
	assert(r <= n);
  800a96:	68 08 23 80 00       	push   $0x802308
  800a9b:	68 0f 23 80 00       	push   $0x80230f
  800aa0:	6a 7b                	push   $0x7b
  800aa2:	68 24 23 80 00       	push   $0x802324
  800aa7:	e8 ea 09 00 00       	call   801496 <_panic>
	assert(r <= PGSIZE);
  800aac:	68 2f 23 80 00       	push   $0x80232f
  800ab1:	68 0f 23 80 00       	push   $0x80230f
  800ab6:	6a 7c                	push   $0x7c
  800ab8:	68 24 23 80 00       	push   $0x802324
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b6d:	68 3b 23 80 00       	push   $0x80233b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f2d:	c3                   	ret    
		assert(r < 1600 && r <= len);
  800f2e:	68 47 23 80 00       	push   $0x802347
  800f33:	68 0f 23 80 00       	push   $0x80230f
  800f38:	6a 62                	push   $0x62
  800f3a:	68 5c 23 80 00       	push   $0x80235c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800f8b:	c3                   	ret    
	assert(size < 1600);
  800f8c:	68 68 23 80 00       	push   $0x802368
  800f91:	68 0f 23 80 00       	push   $0x80230f
  800f96:	6a 6d                	push   $0x6d
  800f98:	68 5c 23 80 00       	push   $0x80235c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fe4:	68 74 23 80 00       	push   $0x802374
  800fe9:	53                   	push   %ebx
...
00801044 <_pipeisclosed>:
{
  ...
  801087:	50                   	push   %eax
  801088:	53                   	push   %ebx
  801089:	68 7b 23 80 00       	push   $0x80237b
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801329:	68 93 23 80 00       	push   $0x802393
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8014b2:	56                   	push   %esi
  8014b3:	50                   	push   %eax
  8014b4:	68 a0 23 80 00       	push   $0x8023a0
  ...
  8014c5:	e8 56 00 00 00       	call   801520 <vcprintf>
	cprintf("\n");
  8014ca:	c7 04 24 8c 23 80 00 	movl   $0x80238c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80161a:	0f be 80 c3 23 80 00 	movsbl 0x8023c3(%eax),%eax
  801621:	50                   	push   %eax
...
0080166e <vprintfmt>:
{
  ...
  801791:	52                   	push   %edx
  801792:	68 21 23 80 00       	push   $0x802321
  801797:	53                   	push   %ebx
  801798:	56                   	push   %esi
  ...
  8017a9:	50                   	push   %eax
  8017aa:	68 db 23 80 00       	push   $0x8023db
  8017af:	53                   	push   %ebx
  8017b0:	56                   	push   %esi
  ...
  8017d1:	b8 d4 23 80 00       	mov    $0x8023d4,%eax
