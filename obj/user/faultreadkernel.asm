	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ec:	0f be 80 71 22 80 00 	movsbl 0x802271(%eax),%eax
  8001f3:	50                   	push   %eax
...
00800240 <vprintfmt>:
{
  ...
  80028c:	ff 24 85 c0 23 80 00 	jmp    *0x8023c0(,%eax,4)
  ...
  800358:	8b 14 85 20 25 80 00 	mov    0x802520(,%eax,4),%edx
  80035f:	85 d2                	test   %edx,%edx
  800361:	74 18                	je     80037b <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800363:	52                   	push   %edx
  800364:	68 55 26 80 00       	push   $0x802655
  800369:	53                   	push   %ebx
  80036a:	56                   	push   %esi
  ...
  80037b:	50                   	push   %eax
  80037c:	68 89 22 80 00       	push   $0x802289
  800381:	53                   	push   %ebx
  800382:	56                   	push   %esi
  ...
  8003a3:	b8 82 22 80 00       	mov    $0x802282,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b0c:	68 7f 25 80 00       	push   $0x80257f
  800b11:	6a 23                	push   $0x23
  800b13:	68 9c 25 80 00       	push   $0x80259c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3b:	68 7f 25 80 00       	push   $0x80257f
  800d40:	6a 23                	push   $0x23
  800d42:	68 9c 25 80 00       	push   $0x80259c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e40:	ba 28 26 80 00       	mov    $0x802628,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800e62:	51                   	push   %ecx
  800e63:	50                   	push   %eax
  800e64:	68 ac 25 80 00       	push   $0x8025ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010bc:	53                   	push   %ebx
  8010bd:	50                   	push   %eax
  8010be:	68 ed 25 80 00       	push   $0x8025ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801185:	53                   	push   %ebx
  801186:	50                   	push   %eax
  801187:	68 09 26 80 00       	push   $0x802609
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80122d:	53                   	push   %ebx
  80122e:	50                   	push   %eax
  80122f:	68 cc 25 80 00       	push   $0x8025cc
...
00801435 <devfile_read>:
{
  ...
  80148a:	c3                   	ret    
	assert(r <= n);
  80148b:	68 3c 26 80 00       	push   $0x80263c
  801490:	68 43 26 80 00       	push   $0x802643
  801495:	6a 7b                	push   $0x7b
  801497:	68 58 26 80 00       	push   $0x802658
  80149c:	e8 ea 09 00 00       	call   801e8b <_panic>
	assert(r <= PGSIZE);
  8014a1:	68 63 26 80 00       	push   $0x802663
  8014a6:	68 43 26 80 00       	push   $0x802643
  8014ab:	6a 7c                	push   $0x7c
  8014ad:	68 58 26 80 00       	push   $0x802658
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801562:	68 6f 26 80 00       	push   $0x80266f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801922:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801923:	68 7b 26 80 00       	push   $0x80267b
  801928:	68 43 26 80 00       	push   $0x802643
  80192d:	6a 62                	push   $0x62
  80192f:	68 90 26 80 00       	push   $0x802690
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801980:	c3                   	ret    
	assert(size < 1600);
  801981:	68 9c 26 80 00       	push   $0x80269c
  801986:	68 43 26 80 00       	push   $0x802643
  80198b:	6a 6d                	push   $0x6d
  80198d:	68 90 26 80 00       	push   $0x802690
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019d9:	68 a8 26 80 00       	push   $0x8026a8
  8019de:	53                   	push   %ebx
...
00801a39 <_pipeisclosed>:
{
  ...
  801a7c:	50                   	push   %eax
  801a7d:	53                   	push   %ebx
  801a7e:	68 af 26 80 00       	push   $0x8026af
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d1e:	68 c7 26 80 00       	push   $0x8026c7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801eba:	e8 33 e2 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801ebf:	c7 04 24 c0 26 80 00 	movl   $0x8026c0,(%esp)
...
void ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f72:	50                   	push   %eax
  801f73:	68 f8 26 80 00       	push   $0x8026f8
  801f78:	6a 3d                	push   $0x3d
  801f7a:	68 0c 27 80 00       	push   $0x80270c
